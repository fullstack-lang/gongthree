...
import (
	...
	gongthree_orm "github.com/fullstack-lang/gongthree/go/orm"
...
type Controller struct {
	...
	Map_BackRepos map[string]*gongthree_orm.BackRepoStruct
...
func GetController() *Controller {
	doControllerInitOnce.Do(func() {
		_controllerSingloton = &Controller{
			Map_BackRepos: make(map[string]*gongthree_orm.BackRepoStruct),
		}
	})
	return _controllerSingloton
}

func (controller *Controller) AddBackRepo(backRepo *gongthree_orm.BackRepoStruct, stackPath string) {

...
import (
	...
	"github.com/fullstack-lang/gongthree/go/fullstack"
	"github.com/fullstack-lang/gongthree/go/models"
	"github.com/fullstack-lang/gongthree/go/orm"
	"github.com/fullstack-lang/gongthree/go/probe"

	gongthree_go "github.com/fullstack-lang/gongthree/go"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.StageStruct) {
	...
	stage.Checkout()
	stage.Marshall(file, "github.com/fullstack-lang/gongthree/go/models", "main")
}
...
func NewStack(
	...
	if withProbe {
		stack.Probe = probe.NewProbe(r, gongthree_go.GoModelsDir, gongthree_go.GoDiagramsDir,

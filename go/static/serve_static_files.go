...
import (
	...
	"github.com/fullstack-lang/gongthree"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(gongthree.NgDistNg, "ng-github.com-fullstack-lang-gongthree/dist/ng-github.com-fullstack-lang-gongthree/browser")))

...
import * as gongthree from '../../projects/gongthree/src/public-api'

import { GongthreespecificComponent } from '../../projects/gongthreespecific/src/public-api'
...
export class AppComponent implements OnInit {
  ...
  gongthree = 'Gongthree'
  probe = 'Gongthree Data/Model'
  view = this.gongthree

  views: string[] = [this.gongthree, this.probe];
